...
export default function EngWrapped() {
  ...
  const slideDurations = [
    ...
    3000,  // 1: Big Numbers
    4000,  // 2: Teams
    2500,  // 3: Big Features Intro
    1900,  // 4: Self-Healing CI
    1900,  // 5: Terminal UI
    1900,  // 6: .NET + Maven
    1900,  // 7: AI Code Generation
    1900,  // 8: CPU/Memory Tracking
    1900,  // 9: Flaky Task Analytics
    1900,  // 10: Onboarding Flow
    1900,  // 11: Azure Single Tenant
    1900,  // 12: Helm Chart
    1900,  // 13: Observability
    2400,  // 14: Framework Support
    2400,  // 15: Cloud Highlights
    2400,  // 16: Infrastructure Highlights
    2400,  // 17: RedPanda Highlights
    2500,  // 18: Stats Intro
  ...
  return (
    <div ref={containerRef} className="bg-zinc-950 text-white h-screen overflow-hidden relative">
      ...
      <button
        ...
        className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 px-4 py-2 bg-zinc-800/80 hover:bg-zinc-700/80 backdrop-blur-sm rounded-full transition-all duration-300 border border-zinc-700"
      >
        {isPlaying ? (
      ...
      <Section className="bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950">
        <div className="text-center max-w-2xl">
          ...
          <h1 className="text-6xl font-black mb-4 bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 bg-clip-text text-transparent">
            2025 Wrapped
          </h1>
      ...
      <Section className="bg-zinc-900">
        <div className="max-w-4xl w-full">
          <h2 className="text-3xl font-bold mb-6 text-center">The Teams</h2>
      ...
      <Section className="bg-zinc-950">
        <div className="text-center max-w-4xl">
          ...
          <h2 className="text-4xl font-bold mb-8">Every Major Release</h2>
      ...
      <Section className="bg-zinc-900">
        <div className="text-center max-w-4xl">
          ...
          <h2 className="text-4xl font-bold mb-8">Smarter & Easier to Use</h2>
          <div className="grid grid-cols-4 gap-4">
      ...
      <Section className="bg-zinc-950">
        <div className="text-center max-w-4xl">
          ...
          <h2 className="text-4xl font-bold mb-8">Any Cloud • Any Scale • Always On</h2>
          <div className="grid grid-cols-4 gap-4">
      ...
      <Section className="bg-zinc-900">
        <div className="text-center max-w-4xl">
          ...
          <h2 className="text-4xl font-bold mb-8">AI-Powered CI</h2>
      ...
      <Section className="bg-zinc-950">
        <div className="text-center max-w-2xl">
          ...
          <p className="text-zinc-400 text-xl">A look at what we shipped in 2025</p>
        </div>
      </Section>
